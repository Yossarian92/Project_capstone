...
weather_api_token = '309fc2f58a75628cd171960498f67195' # create account at https://darksky.net/dev/
...
class Weather(Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.iconLbl.pack(side=LEFT, anchor=N, padx=5)
...
def face_recog():
    subprocess.check_output('./face_recog.sh', shell=True)

def cMR():
    with PiCamera() as camera:
        camera.start_preview(fullscreen=False, window=(520,110,280,280))
        time.sleep(5)
...
class FullscreenWindow:
    def __init__(self):
        ...
        self.clock.pack(side=RIGHT, anchor=N, padx=40, pady=30)
        # weather
        self.weather = Weather(self.topFrame)
        self.weather.pack(side=LEFT, anchor=N, padx=30, pady=20)
        # news
        self.news = News(self.bottomFrame)
        self.news.pack(side=LEFT, anchor=S, padx=30, pady=0)
        # calender - removing for now
        # self.calender = Calendar(self.bottomFrame)
        # self.calender.pack(side = RIGHT, anchor=S, padx=10, pady=10)
        # button
        self.ButtonEvent = ButtonEvent(self.bottomFrame)
        self.ButtonEvent.pack(side=RIGHT, anchor=S, padx=10, pady=10)
